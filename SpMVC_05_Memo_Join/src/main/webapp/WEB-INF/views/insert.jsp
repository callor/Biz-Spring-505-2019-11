...
<fieldset>
	...
	<form:form modelAttribute="memoDTO"  autocomplete="on"  class="memo-form">
		...
		<form:input type="date" path="m_date" 
				class="in-box" placeholder="작성일자"  /><br/>
				
		<form:input type="time" path="m_time" 
				class="in-box" placeholder="작성시각"  /><br/>
		
		<form:input path="m_auth" 
				class="in-box" placeholder="작성자 id"  /><br/>

		<form:input path="m_subject" 
