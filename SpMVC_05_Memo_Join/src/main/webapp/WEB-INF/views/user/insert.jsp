...
<fieldset>
	...
	<form:form modelAttribute="userDTO"  
		...
		<form:input type="email" path="u_id" 
				class="in-box" placeholder="이메일주소를 입력하세요"  /><br/>
				
		<form:input type="password" path="u_password" 
				class="in-box" placeholder="비밀번호를 입력하세요"  /><br/>
		
		<input type="password" id="re_password" 
					placeholder="비밀번호를 한번더 입력하세요">
		
		<form:input path="u_name" 
				class="in-box" placeholder="이름을 입력하세요"  /><br/>

		<form:input path="u_nick" 
				class="in-box" placeholder="별명을 입력하세요"  /><br/>

		<form:input path="u_tel" type="number"
				class="in-box" placeholder="전화번호를 입력하세요"  /><br/>
