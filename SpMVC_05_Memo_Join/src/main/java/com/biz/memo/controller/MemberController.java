...
public class MemberController {
	...
	public String login(UserDTO userDTO, Model model,
		...
		// DB정보화 일치하는 검사
		if(userDTO.getU_id()
				.equalsIgnoreCase(getUserDTO.getU_id())
			&& userDTO.getU_password()
				.equals(getUserDTO.getU_password())) {
