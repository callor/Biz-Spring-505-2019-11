...
<article class="page-box">
	<ul class="page-body">
		<li class="page-item">
		<a href="${rootPath}/search?cat=${cat}&search=${search}&currentPageNo=${PAGE.firstPageNo}" class="page-link">[처음]</a>	
		...
		<li class="page-item">
		<a href="${rootPath}/search?cat=${cat}&search=${search}&currentPageNo=${PAGE.nextPageNo}" class="page-link">&gt;</a>
		<li class="page-item">
		<a href="${rootPath}/search?cat=${cat}&search=${search}&currentPageNo=${PAGE.finalPageNo}" class="page-link">[끝]</a>
	</ul>
</article>
