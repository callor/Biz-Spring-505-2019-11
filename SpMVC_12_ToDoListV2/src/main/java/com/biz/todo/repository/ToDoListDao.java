...
public interface ToDoListDao {
	...
	/*
	 * mapper Annotaion에는 문자열로 SQL문을 작성해야 하는데
	 * SQL문이 복잡할경우는 별도의 String 문자열변수를 불러와서
	 * 사용할수 있다.
	 * 
	 * 이때
	...
	public int complete(
			@Param("td_seq") long td_seq);

	/*
	 * ToDoListSQL 클래스에 정의된 alarm_sql method를 호출하여
	 * 동적 쿼리를 가져와서 Update를 수행하라
	 */
	@UpdateProvider(type = ToDoListSQL.class,method = "alaram_sql")
	public int alarm(
			@Param("td_seq") long tdSeq);
