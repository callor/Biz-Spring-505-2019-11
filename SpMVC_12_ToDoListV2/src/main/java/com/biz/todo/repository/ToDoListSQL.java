...
public class ToDoListSQL {
	...
	public String insert_sql(final ToDoList toDoList) {
		...
		return new SQL() {{
			...
			INTO_COLUMNS("TD_SEQ").INTO_COLUMNS("TD_DATE");
			INTO_COLUMNS("TD_TIME").INTO_COLUMNS("TD_SUBJECT");
			INTO_COLUMNS("TD_TEXT").INTO_COLUMNS("TD_FLAG");
			INTO_COLUMNS("TD_COMPLETE").INTO_COLUMNS("TD_ALARM");
	...
	/*
	 * SQL class
	 * myabtis 3.4(3.5) 이상에서 사용되는 동적 쿼리를 지원하는 클래스
	 */
	public String alaram_sql() {
