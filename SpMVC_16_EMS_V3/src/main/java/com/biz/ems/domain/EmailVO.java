...
public class EmailVO {
	 ...
	 * 필드변수화 칼럼의 이름을 달리 설정하고자 할때
	 */
	@Column(name="to_email", 
			nullable = false,length = 125)
	private String to_email;

	
	@Nationalized 
	// 문자열 칼럼 type을 locale type에 따라 변경
	// nvarhchar
