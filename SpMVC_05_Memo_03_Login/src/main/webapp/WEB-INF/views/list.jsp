...
<body>
	...
	상당히 불편하고
	만약 배포된 상태에서 불특정 다수가 웹을통해 접속했을경우
	사용자에게 일일이 브라우저 방문기록을 삭제해달라 요청할수도 없다.
	
	그래서 대안으로 파일이름을 변경하여 서버를 reloading하는 방법이 있느데
	...
	?ver-*** 라는 query를 부착하여
	버전 숫자를 변경하고
	tomcat을 reloading 해주면 대부문의 문제가 해결된다.
	
	따라서
	css,js 파일의 코드를 변경한 후에는
