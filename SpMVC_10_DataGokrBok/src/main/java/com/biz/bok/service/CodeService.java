...
public class CodeService {
	...
	public Map<String,Map<String,String>> getSelectMaps() {
		Map<String,Map<String,String>> selectMaps 
	...
	public Map<String, String> lifeArray() {
		...
		/*
		 * 001, 영유아 002, 아동 003, 청소년 004, 청년 005, 중장년 006, 노년
		 */
	...
	public Map<String, String> charTrgterArray() {
		...
		/*
		 * 001, 해당없음 002, 여성 003, 임산부 004, 장애 005, 국가유공자등 보훈대상자 006, 실업자
		 */
	...
	public Map<String, String> obstKiArray() {
		...
		/*
		 * 10, 지체 20, 시각 30, 청각 40, 언어 50, 지적 60, 뇌병변 70, 자폐성 80, 정신 90, 신장 A0, 심장 B0,
		 * 호흡기 C0, 간 D0, 안면 E0, 장루 F0, 간질
		 */
